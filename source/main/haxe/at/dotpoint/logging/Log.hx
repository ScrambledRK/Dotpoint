...
class Log
{
	...
	public static var loggerList(default,null):Array<ILogger>;
	 ...
	 * @param	?info
	 */
	inline private static function delegateLog( logger:ILogger, type:LogType, value:Dynamic, ?info:PosInfos ):Void
	{
