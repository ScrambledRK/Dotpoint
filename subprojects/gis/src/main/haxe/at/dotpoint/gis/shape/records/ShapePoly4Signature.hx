 ...
 * @author RK
 */
class ShapePoly4Signature extends AShapeRecordSignature
{
	...
	public function new() 
	{
		...
		this.format[7] = new ByteFormat( ByteType.FLOAT, 2, false );	// m range
		this.format[8] = new ByteFormat( ByteType.FLOAT, 1, false );	// m values
	}	
