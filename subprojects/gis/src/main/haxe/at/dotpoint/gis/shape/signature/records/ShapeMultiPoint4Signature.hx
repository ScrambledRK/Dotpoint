 ...
 * @author RK
 */
class ShapeMultiPoint4Signature extends AShapeRecordSignature
{
	...
	public function new() 
	{
		...
		this.format[5] = new ByteFormat( ByteType.FLOAT, 2, false );	// m range
		this.format[6] = new ByteFormat( ByteType.FLOAT, 1, false );	// m values
	}	
