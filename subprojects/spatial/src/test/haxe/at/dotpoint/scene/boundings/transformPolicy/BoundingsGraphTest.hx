...
class BoundingsGraphTest
{
	...
	private function testChangeModel():Void
	{
		...
		Assert.areEqual( 20, local.length );

		Assert.areEqual( 20, world.width  );
		Assert.areEqual( 40, world.height );
		Assert.areEqual( 20, world.length );
		...
		Assert.isTrue( Vector3.isEqual( local.max, new Vector3( 20, 40, 20 ) ) );

		Assert.isTrue( Vector3.isEqual( world.min, new Vector3(  0,  0,  0 ) ) );
		Assert.isTrue( Vector3.isEqual( world.max, new Vector3( 20, 40, 20 ) ) );
	...
	{
		this.root.boundings.localSpace.width  = 10; // 0.5
		this.root.boundings.localSpace.height = 40; // 2
		this.root.boundings.localSpace.length = 10; // 1
		...
		Assert.isTrue( Vector3.isEqual( local.min, new Vector3(  0,  0, 10 ) ) );
		Assert.isTrue( Vector3.isEqual( local.max, new Vector3( 10, 40, 20 ) ) );

		Assert.isTrue( Vector3.isEqual( world.min, new Vector3(  0,  0, 10 ) ) );
		Assert.isTrue( Vector3.isEqual( world.max, new Vector3( 10, 40, 20 ) ) );

		// ------------------------ //

		Assert.areEqual( 0.5, this.root.transform.scale.x );
		Assert.areEqual( 2,   this.root.transform.scale.y );
		Assert.areEqual( 1,   this.root.transform.scale.z );
		...
		Assert.isTrue( Vector3.isEqual( this.n1_1.boundings.worldSpace.min, new Vector3(  5,  0, 10 ) ) );
		Assert.isTrue( Vector3.isEqual( this.n1_1.boundings.worldSpace.max, new Vector3( 10, 20, 20 ) ) );

		Assert.isTrue( Vector3.isEqual( this.n1_2.boundings.localSpace.min, new Vector3(  0, 10, 10 ) ) );
		Assert.isTrue( Vector3.isEqual( this.n1_2.boundings.localSpace.max, new Vector3( 10, 20, 20 ) ) );

		Assert.isTrue( Vector3.isEqual( this.n1_2.boundings.worldSpace.min, new Vector3(  0, 20, 10 ) ) );
		Assert.isTrue( Vector3.isEqual( this.n1_2.boundings.worldSpace.max, new Vector3(  5, 40, 20 ) ) );
	}
	...
	{
		this.root.boundings.worldSpace.width  = 10; // 0.5
		this.root.boundings.worldSpace.height = 40; // 2
		this.root.boundings.worldSpace.length = 10; // 1
