...
class AVector2Test<TVector2:IVector2> extends haxe.unit.TestCase
{
	...
	//
	private function createVectorA():TVector2
	{
		var a:TVector2 = this.createVector();
			a.x = 0.5;
			a.y = -10;
	...
	//
	private function createVectorB():TVector2
	{
		var b:TVector2 = this.createVector();
			b.x = 0.5;
			b.y = 10;
	...
	{
		var a:IVector2 = this.createVectorA();
		var b:IVector2 = this.createVectorB();
	...
	private function testNormalize():Void
	{
		...
		var b:IVector2 = this.createVectorA();
