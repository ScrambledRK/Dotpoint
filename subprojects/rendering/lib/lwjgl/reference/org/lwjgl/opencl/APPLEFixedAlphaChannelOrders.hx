...
@:native("org.lwjgl.opencl.APPLEFixedAlphaChannelOrders")
@:final
/**
 ...
 */
extern class APPLEFixedAlphaChannelOrders 
{
	inline static public var CL_1RGB_APPLE:Int = 268435462;
	inline static public var CL_BGR1_APPLE:Int = 268435463;
