...
@:native("org.lwjgl.opencl.AMDDeviceTopology")
@:final
/**
 ...
 */
extern class AMDDeviceTopology 
{
/**
 ...
 */
	inline static public var CL_DEVICE_TOPOLOGY_AMD:Int = 16439;
/** Indicates the type of the struct returned by {@link #CL_DEVICE_TOPOLOGY_AMD DEVICE_TOPOLOGY_AMD}.  */
	inline static public var CL_DEVICE_TOPOLOGY_TYPE_PCIE_AMD:Int = 1;
