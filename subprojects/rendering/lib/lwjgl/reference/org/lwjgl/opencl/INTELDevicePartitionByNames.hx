...
@:native("org.lwjgl.opencl.INTELDevicePartitionByNames")
@:final
/**
 * Native bindings to the <a href="http://www.khronos.org/registry/cl/extensions/intel/cl_intel_device_partition_by_names.txt">intel_device_partition_by_names</a> extension.
 * 
 ...
 * </ul></p>
 */
extern class INTELDevicePartitionByNames 
{
/** Accepted in the {@code properties} argument of {@link CL12#clCreateSubDevices CreateSubDevices}.  */
	inline static public var CL_DEVICE_PARTITION_BY_NAMES_INTEL:Int = 16466;
/** The name list terminator.  */
	inline static public var CL_PARTITION_BY_NAMES_LIST_END_INTEL:Int = -1;
