...
@:native("org.lwjgl.opencl.INTELSimultaneousSharing")
@:final
/**
 * Native bindings to the <a href="http://www.khronos.org/registry/cl/extensions/intel/cl_intel_simultaneous_sharing.txt">intel_simultaneous_sharing</a> extension.
 * 
 ...
 */
extern class INTELSimultaneousSharing 
{
/**
 ...
 */
	inline static public var CL_DEVICE_SIMULTANEOUS_INTEROPS_INTEL:Int = 16644;
/**
 * Accepted as a property being queried in the {@code param_name} parameter of {@link CL10#clGetDeviceInfo GetDeviceInfo}.
 * 
 ...
 */
	inline static public var CL_DEVICE_NUM_SIMULTANEOUS_INTEROPS_INTEL:Int = 16645;
