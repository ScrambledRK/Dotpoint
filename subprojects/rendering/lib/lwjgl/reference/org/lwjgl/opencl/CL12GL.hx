...
@:native("org.lwjgl.opencl.CL12GL")
@:final
/** The OpenCL 1.2 OpenGL interoperability functionality.  */
extern class CL12GL 
{
/** cl_gl_object_type  */
	inline static public var CL_GL_OBJECT_TEXTURE_2D_ARRAY:Int = 8206;
/** cl_gl_object_type  */
	inline static public var CL_GL_OBJECT_TEXTURE1D:Int = 8207;
/** cl_gl_object_type  */
	inline static public var CL_GL_OBJECT_TEXTURE1D_ARRAY:Int = 8208;
/** cl_gl_object_type  */
	inline static public var CL_GL_OBJECT_TEXTURE_BUFFER:Int = 8209;
/** Function address.  */
	public var CreateFromGLTexture:haxe.Int64;
...
/** JNI method for {@link #clCreateFromGLTexture CreateFromGLTexture}  */
	static public function nclCreateFromGLTexture(context:haxe.Int64,flags:haxe.Int64,texture_target:Int,miplevel:Int,texture:Int,errcode_ret:haxe.Int64,__functionAddress:haxe.Int64):haxe.Int64;
...
/** Returns the {@link CL12GL} instance for the currently loaded ICD.  */
	static public function getInstance():org.lwjgl.opencl.CL12GL;
/**
...
/** Alternative version of: {@link #clCreateFromGLTexture CreateFromGLTexture}  */
	static public function clCreateFromGLTexture(context:haxe.Int64,flags:haxe.Int64,texture_target:Int,miplevel:Int,texture:Int,errcode_ret:java.nio.IntBuffer):haxe.Int64;
