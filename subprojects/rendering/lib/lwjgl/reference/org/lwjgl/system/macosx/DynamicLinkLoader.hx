...
@:native("org.lwjgl.system.macosx.DynamicLinkLoader")
@:final
...
/** The {@code mode} argument to {@link #dlopen} contains one of the following.  */
	inline static public var RTLD_LOCAL:Int = 4;
/** The {@code mode} argument to {@link #dlopen} contains one of the following.  */
	inline static public var RTLD_GLOBAL:Int = 8;
/** Special-handle values for {@link #dlsym}.  */
	inline static public var RTLD_NEXT:haxe.Int64 = -1;
/** Special-handle values for {@link #dlsym}.  */
	inline static public var RTLD_DEFAULT:haxe.Int64 = -2;
/** Special-handle values for {@link #dlsym}.  */
	inline static public var RTLD_SELF:haxe.Int64 = -3;
/** Special-handle values for {@link #dlsym}.  */
	inline static public var RTLD_MAIN_ONLY:haxe.Int64 = -5;
/**
...
/** JNI method for {@link #dlopen}  */
	static public function ndlopen(path:haxe.Int64,mode:Int):haxe.Int64;
 ...
 *             </ul></p>
 */
	static public function dlopen(path:java.nio.ByteBuffer,mode:Int):haxe.Int64;
	@:overload(function (path:java.lang.CharSequence,mode:Int):haxe.Int64 {})
