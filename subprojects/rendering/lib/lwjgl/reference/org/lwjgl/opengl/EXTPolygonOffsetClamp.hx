...
@:native("org.lwjgl.opengl.EXTPolygonOffsetClamp")
@:final
/**
 ...
 */
extern class EXTPolygonOffsetClamp 
{
/** Accepted by the {@code pname} parameters of GetBooleanv, GetIntegerv, GetInteger64v, GetFloatv, and GetDoublev.  */
	inline static public var GL_POLYGON_OFFSET_CLAMP_EXT:Int = 36379;
/** Function address.  */
	public var PolygonOffsetClampEXT:haxe.Int64;
 ...
 */
	static public function glPolygonOffsetClampEXT(factor:Float,units:Float,clamp:Float):Void;
/** JNI method for {@link #glPolygonOffsetClampEXT PolygonOffsetClampEXT}  */
	static public function nglPolygonOffsetClampEXT(factor:Float,units:Float,clamp:Float,__functionAddress:haxe.Int64):Void;
/** Returns the {@link EXTPolygonOffsetClamp} instance for the current context.  */
	static public function getInstance():org.lwjgl.opengl.EXTPolygonOffsetClamp;
