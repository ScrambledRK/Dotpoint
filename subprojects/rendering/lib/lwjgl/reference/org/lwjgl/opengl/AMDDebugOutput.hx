...
@:native("org.lwjgl.opengl.AMDDebugOutput")
@:final
/**
 ...
 */
extern class AMDDebugOutput 
{
/** Tokens accepted by GetIntegerv.  */
	inline static public var GL_MAX_DEBUG_MESSAGE_LENGTH_AMD:Int = 37187;
/** Tokens accepted by GetIntegerv.  */
	inline static public var GL_MAX_DEBUG_LOGGED_MESSAGES_AMD:Int = 37188;
/** Tokens accepted by GetIntegerv.  */
	inline static public var GL_DEBUG_LOGGED_MESSAGES_AMD:Int = 37189;
/** Tokens accepted by DebugMessageEnableAMD, GetDebugMessageLogAMD, DebugMessageInsertAMD, and DEBUGPROCAMD callback function for {@code severity}.  */
	inline static public var GL_DEBUG_SEVERITY_HIGH_AMD:Int = 37190;
/** Tokens accepted by DebugMessageEnableAMD, GetDebugMessageLogAMD, DebugMessageInsertAMD, and DEBUGPROCAMD callback function for {@code severity}.  */
	inline static public var GL_DEBUG_SEVERITY_MEDIUM_AMD:Int = 37191;
/** Tokens accepted by DebugMessageEnableAMD, GetDebugMessageLogAMD, DebugMessageInsertAMD, and DEBUGPROCAMD callback function for {@code severity}.  */
	inline static public var GL_DEBUG_SEVERITY_LOW_AMD:Int = 37192;
/** Tokens accepted by DebugMessageEnableAMD, GetDebugMessageLogAMD, and DEBUGPROCAMD callback function for {@code category}.  */
	inline static public var GL_DEBUG_CATEGORY_API_ERROR_AMD:Int = 37193;
/** Tokens accepted by DebugMessageEnableAMD, GetDebugMessageLogAMD, and DEBUGPROCAMD callback function for {@code category}.  */
	inline static public var GL_DEBUG_CATEGORY_WINDOW_SYSTEM_AMD:Int = 37194;
/** Tokens accepted by DebugMessageEnableAMD, GetDebugMessageLogAMD, and DEBUGPROCAMD callback function for {@code category}.  */
	inline static public var GL_DEBUG_CATEGORY_DEPRECATION_AMD:Int = 37195;
/** Tokens accepted by DebugMessageEnableAMD, GetDebugMessageLogAMD, and DEBUGPROCAMD callback function for {@code category}.  */
	inline static public var GL_DEBUG_CATEGORY_UNDEFINED_BEHAVIOR_AMD:Int = 37196;
/** Tokens accepted by DebugMessageEnableAMD, GetDebugMessageLogAMD, and DEBUGPROCAMD callback function for {@code category}.  */
	inline static public var GL_DEBUG_CATEGORY_PERFORMANCE_AMD:Int = 37197;
/** Tokens accepted by DebugMessageEnableAMD, GetDebugMessageLogAMD, and DEBUGPROCAMD callback function for {@code category}.  */
	inline static public var GL_DEBUG_CATEGORY_SHADER_COMPILER_AMD:Int = 37198;
/** Tokens accepted by DebugMessageEnableAMD, GetDebugMessageLogAMD, and DEBUGPROCAMD callback function for {@code category}.  */
	inline static public var GL_DEBUG_CATEGORY_APPLICATION_AMD:Int = 37199;
/** Tokens accepted by DebugMessageEnableAMD, GetDebugMessageLogAMD, and DEBUGPROCAMD callback function for {@code category}.  */
	inline static public var GL_DEBUG_CATEGORY_OTHER_AMD:Int = 37200;
/** Function address.  */
	public var DebugMessageEnableAMD:haxe.Int64;
/** Function address.  */
	public var DebugMessageInsertAMD:haxe.Int64;
/** Function address.  */
	public var DebugMessageCallbackAMD:haxe.Int64;
/** Function address.  */
	public var GetDebugMessageLogAMD:haxe.Int64;
 ...
 */
	static public function glDebugMessageEnableAMD(category:Int,severity:Int,count:Int,ids:java.nio.ByteBuffer,enabled:Bool):Void;
	@:overload(function (category:Int,severity:Int,ids:java.nio.IntBuffer,enabled:Bool):Void {})
 ...
 */
	static public function glGetDebugMessageLogAMD(count:Int,bufsize:Int,categories:java.nio.ByteBuffer,severities:java.nio.ByteBuffer,ids:java.nio.ByteBuffer,lengths:java.nio.ByteBuffer,messageLog:java.nio.ByteBuffer):Int;
	@:overload(function (count:Int,categories:java.nio.IntBuffer,severities:java.nio.IntBuffer,ids:java.nio.IntBuffer,lengths:java.nio.IntBuffer,messageLog:java.nio.ByteBuffer):Int {})
...
/** JNI method for {@link #glDebugMessageEnableAMD DebugMessageEnableAMD}  */
	static public function nglDebugMessageEnableAMD(category:Int,severity:Int,count:Int,ids:haxe.Int64,enabled:Bool,__functionAddress:haxe.Int64):Void;
	@:overload(function (category:Int,severity:Int,count:Int,ids:haxe.Int64,enabled:Bool):Void {})
/** JNI method for {@link #glDebugMessageCallbackAMD DebugMessageCallbackAMD}  */
	static public function nglDebugMessageCallbackAMD(callback_:haxe.Int64,userParam:haxe.Int64,__functionAddress:haxe.Int64):Void;
/**
 ...
 */
	static public function GLDebugMessageAMDCallback(sam:org.lwjgl.opengl.GLDebugMessageAMDCallback_SAM):org.lwjgl.opengl.GLDebugMessageAMDCallback;
/** Returns the {@link AMDDebugOutput} instance for the current context.  */
	static public function getInstance():org.lwjgl.opengl.AMDDebugOutput;
 ...
 */
	static public function glDebugMessageInsertAMD(category:Int,severity:Int,id:Int,length:Int,buf:java.nio.ByteBuffer):Void;
	@:overload(function (category:Int,severity:Int,id:Int,buf:java.lang.CharSequence):Void {})
	@:overload(function (category:Int,severity:Int,id:Int,buf:java.nio.ByteBuffer):Void {})
/**
 ...
 */
	static public function glDebugMessageCallbackAMD(callback_:org.lwjgl.opengl.GLDebugMessageAMDCallback,userParam:haxe.Int64):Void;
...
/** JNI method for {@link #glGetDebugMessageLogAMD GetDebugMessageLogAMD}  */
	static public function nglGetDebugMessageLogAMD(count:Int,bufsize:Int,categories:haxe.Int64,severities:haxe.Int64,ids:haxe.Int64,lengths:haxe.Int64,messageLog:haxe.Int64,__functionAddress:haxe.Int64):Int;
	@:overload(function (count:Int,bufsize:Int,categories:haxe.Int64,severities:haxe.Int64,ids:haxe.Int64,lengths:haxe.Int64,messageLog:haxe.Int64):Int {})
...
/** JNI method for {@link #glDebugMessageInsertAMD DebugMessageInsertAMD}  */
	static public function nglDebugMessageInsertAMD(category:Int,severity:Int,id:Int,length:Int,buf:haxe.Int64,__functionAddress:haxe.Int64):Void;
	@:overload(function (category:Int,severity:Int,id:Int,length:Int,buf:haxe.Int64):Void {})
