...
@:native("org.lwjgl.opengl.ARBDepthClamp")
@:final
/**
 * Native bindings to the <a href="http://www.opengl.org/registry/specs/ARB/depth_clamp.txt">ARB_depth_clamp</a> extension.
 * 
