...
@:native("org.lwjgl.opengl.ARBFramebufferSRGB")
@:final
/**
 * Native bindings to the <a href="http://www.opengl.org/registry/specs/ARB/framebuffer_sRGB.txt">ARB_framebuffer_sRGB</a> extension.
 * 
 ...
 */
extern class ARBFramebufferSRGB 
{
/**
