...
@:native("org.lwjgl.opengl.AMDOcclusionQueryEvent")
@:final
/**
 ...
 */
extern class AMDOcclusionQueryEvent 
{
/**
 ...
 */
	inline static public var GL_OCCLUSION_QUERY_EVENT_MASK_AMD:Int = 34639;
/** Accepted by the {@code param} argument to {@link #glQueryObjectParameteruiAMD QueryObjectParameteruiAMD}.  */
	inline static public var GL_QUERY_DEPTH_PASS_EVENT_BIT_AMD:Int = 1;
/** Accepted by the {@code param} argument to {@link #glQueryObjectParameteruiAMD QueryObjectParameteruiAMD}.  */
	inline static public var GL_QUERY_DEPTH_FAIL_EVENT_BIT_AMD:Int = 2;
/** Accepted by the {@code param} argument to {@link #glQueryObjectParameteruiAMD QueryObjectParameteruiAMD}.  */
	inline static public var GL_QUERY_STENCIL_FAIL_EVENT_BIT_AMD:Int = 4;
/** Accepted by the {@code param} argument to {@link #glQueryObjectParameteruiAMD QueryObjectParameteruiAMD}.  */
	inline static public var GL_QUERY_DEPTH_BOUNDS_FAIL_EVENT_BIT_AMD:Int = 8;
/** Accepted by the {@code param} argument to {@link #glQueryObjectParameteruiAMD QueryObjectParameteruiAMD}.  */
	inline static public var GL_QUERY_ALL_EVENT_BITS_AMD:Int = -1;
/** Function address.  */
	public var QueryObjectParameteruiAMD:haxe.Int64;
	public function new(provider:org.lwjgl.system.FunctionProvider):Void;
/** JNI method for {@link #glQueryObjectParameteruiAMD QueryObjectParameteruiAMD}  */
	static public function nglQueryObjectParameteruiAMD(target:Int,id:Int,pname:Int,param:Int,__functionAddress:haxe.Int64):Void;
/** Returns the {@link AMDOcclusionQueryEvent} instance for the current context.  */
	static public function getInstance():org.lwjgl.opengl.AMDOcclusionQueryEvent;
/**
 ...
 */
	static public function glQueryObjectParameteruiAMD(target:Int,id:Int,pname:Int,param:Int):Void;
