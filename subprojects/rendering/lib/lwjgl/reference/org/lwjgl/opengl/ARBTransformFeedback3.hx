...
@:native("org.lwjgl.opengl.ARBTransformFeedback3")
@:final
/**
 ...
 */
extern class ARBTransformFeedback3 
{
...
/** Unsafe version of {@link #glGetQueryIndexediv GetQueryIndexediv}  */
	static public function nglGetQueryIndexediv(target:Int,index:Int,pname:Int,params:haxe.Int64):Void;
/** Returns the {@link ARBTransformFeedback3} instance for the current context.  */
	static public function getInstance():org.lwjgl.opengl.ARBTransformFeedback3;
/**
