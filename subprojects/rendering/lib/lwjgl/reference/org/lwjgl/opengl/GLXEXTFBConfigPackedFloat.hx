...
@:native("org.lwjgl.opengl.GLXEXTFBConfigPackedFloat")
@:final
/**
 ...
 */
extern class GLXEXTFBConfigPackedFloat 
{
/** Accepted as values of the {@code render_type} arguments in the {@link GLX13#glXCreateNewContext CreateNewContext} and {@link GLX#glXCreateContext CreateContext} functions.  */
	inline static public var GLX_RGBA_UNSIGNED_FLOAT_TYPE_EXT:Int = 8369;
/**
 ...
 */
	inline static public var GLX_RGBA_UNSIGNED_FLOAT_BIT_EXT:Int = 8;
