...
@:native("org.lwjgl.opengl.ARBDebugOutput")
@:final
/**
 ...
 */
	inline static public var GL_DEBUG_OUTPUT_SYNCHRONOUS_ARB:Int = 33346;
/** Tokens accepted by the {@code value} parameters of GetBooleanv, GetIntegerv, GetFloatv, and GetDoublev.  */
	inline static public var GL_MAX_DEBUG_MESSAGE_LENGTH_ARB:Int = 37187;
/** Tokens accepted by the {@code value} parameters of GetBooleanv, GetIntegerv, GetFloatv, and GetDoublev.  */
	inline static public var GL_MAX_DEBUG_LOGGED_MESSAGES_ARB:Int = 37188;
/** Tokens accepted by the {@code value} parameters of GetBooleanv, GetIntegerv, GetFloatv, and GetDoublev.  */
	inline static public var GL_DEBUG_LOGGED_MESSAGES_ARB:Int = 37189;
/** Tokens accepted by the {@code value} parameters of GetBooleanv, GetIntegerv, GetFloatv, and GetDoublev.  */
	inline static public var GL_DEBUG_NEXT_LOGGED_MESSAGE_LENGTH_ARB:Int = 33347;
/** Tokens accepted by the {@code pname} parameter of GetPointerv.  */
	inline static public var GL_DEBUG_CALLBACK_FUNCTION_ARB:Int = 33348;
/** Tokens accepted by the {@code pname} parameter of GetPointerv.  */
	inline static public var GL_DEBUG_CALLBACK_USER_PARAM_ARB:Int = 33349;
/**
 ...
 */
	inline static public var GL_DEBUG_SOURCE_API_ARB:Int = 33350;
/**
 * Tokens accepted or provided by the {@code source} parameters of DebugMessageControlARB, DebugMessageInsertARB and DEBUGPROCARB, and the {@code sources}
 * parameter of GetDebugMessageLogARB.
 */
	inline static public var GL_DEBUG_SOURCE_WINDOW_SYSTEM_ARB:Int = 33351;
/**
 * Tokens accepted or provided by the {@code source} parameters of DebugMessageControlARB, DebugMessageInsertARB and DEBUGPROCARB, and the {@code sources}
 * parameter of GetDebugMessageLogARB.
 */
	inline static public var GL_DEBUG_SOURCE_SHADER_COMPILER_ARB:Int = 33352;
/**
 * Tokens accepted or provided by the {@code source} parameters of DebugMessageControlARB, DebugMessageInsertARB and DEBUGPROCARB, and the {@code sources}
 * parameter of GetDebugMessageLogARB.
 */
	inline static public var GL_DEBUG_SOURCE_THIRD_PARTY_ARB:Int = 33353;
/**
 * Tokens accepted or provided by the {@code source} parameters of DebugMessageControlARB, DebugMessageInsertARB and DEBUGPROCARB, and the {@code sources}
 * parameter of GetDebugMessageLogARB.
 */
	inline static public var GL_DEBUG_SOURCE_APPLICATION_ARB:Int = 33354;
/**
 * Tokens accepted or provided by the {@code source} parameters of DebugMessageControlARB, DebugMessageInsertARB and DEBUGPROCARB, and the {@code sources}
 * parameter of GetDebugMessageLogARB.
 */
	inline static public var GL_DEBUG_SOURCE_OTHER_ARB:Int = 33355;
/**
 ...
 * parameter of GetDebugMessageLogARB.
 */
	inline static public var GL_DEBUG_TYPE_ERROR_ARB:Int = 33356;
/**
 * Tokens accepted or provided by the {@code type} parameters of DebugMessageControlARB, DebugMessageInsertARB and DEBUGPROCARB, and the {@code types}
 * parameter of GetDebugMessageLogARB.
 */
	inline static public var GL_DEBUG_TYPE_DEPRECATED_BEHAVIOR_ARB:Int = 33357;
/**
 * Tokens accepted or provided by the {@code type} parameters of DebugMessageControlARB, DebugMessageInsertARB and DEBUGPROCARB, and the {@code types}
 * parameter of GetDebugMessageLogARB.
 */
	inline static public var GL_DEBUG_TYPE_UNDEFINED_BEHAVIOR_ARB:Int = 33358;
/**
 * Tokens accepted or provided by the {@code type} parameters of DebugMessageControlARB, DebugMessageInsertARB and DEBUGPROCARB, and the {@code types}
 * parameter of GetDebugMessageLogARB.
 */
	inline static public var GL_DEBUG_TYPE_PORTABILITY_ARB:Int = 33359;
/**
 * Tokens accepted or provided by the {@code type} parameters of DebugMessageControlARB, DebugMessageInsertARB and DEBUGPROCARB, and the {@code types}
 * parameter of GetDebugMessageLogARB.
 */
	inline static public var GL_DEBUG_TYPE_PERFORMANCE_ARB:Int = 33360;
/**
 * Tokens accepted or provided by the {@code type} parameters of DebugMessageControlARB, DebugMessageInsertARB and DEBUGPROCARB, and the {@code types}
 * parameter of GetDebugMessageLogARB.
 */
	inline static public var GL_DEBUG_TYPE_OTHER_ARB:Int = 33361;
/**
 ...
 */
	inline static public var GL_DEBUG_SEVERITY_HIGH_ARB:Int = 37190;
/**
 * Tokens accepted or provided by the {@code severity} parameters of DebugMessageControlARB, DebugMessageInsertARB and DEBUGPROCARB callback functions, and
 * the {@code severities} parameter of GetDebugMessageLogARB.
 */
	inline static public var GL_DEBUG_SEVERITY_MEDIUM_ARB:Int = 37191;
/**
 * Tokens accepted or provided by the {@code severity} parameters of DebugMessageControlARB, DebugMessageInsertARB and DEBUGPROCARB callback functions, and
 * the {@code severities} parameter of GetDebugMessageLogARB.
 */
	inline static public var GL_DEBUG_SEVERITY_LOW_ARB:Int = 37192;
/** Function address.  */
	public var DebugMessageControlARB:haxe.Int64;
/** Function address.  */
	public var DebugMessageInsertARB:haxe.Int64;
/** Function address.  */
	public var DebugMessageCallbackARB:haxe.Int64;
/** Function address.  */
	public var GetDebugMessageLogARB:haxe.Int64;
...
/** JNI method for {@link #glGetDebugMessageLogARB GetDebugMessageLogARB}  */
	static public function nglGetDebugMessageLogARB(count:Int,bufSize:Int,sources:haxe.Int64,types:haxe.Int64,ids:haxe.Int64,severities:haxe.Int64,lengths:haxe.Int64,messageLog:haxe.Int64,__functionAddress:haxe.Int64):Int;
 ...
 */
	static public function glDebugMessageCallbackARB(callback_:org.lwjgl.opengl.GLDebugMessageARBCallback,userParam:haxe.Int64):Void;
 ...
 */
	static public function glDebugMessageInsertARB(source:Int,type:Int,id:Int,severity:Int,length:Int,buf:java.nio.ByteBuffer):Void;
	@:overload(function (source:Int,type:Int,id:Int,severity:Int,buf:java.lang.CharSequence):Void {})
	@:overload(function (source:Int,type:Int,id:Int,severity:Int,buf:java.nio.ByteBuffer):Void {})
...
/** JNI method for {@link #glDebugMessageInsertARB DebugMessageInsertARB}  */
	static public function nglDebugMessageInsertARB(source:Int,type:Int,id:Int,severity:Int,length:Int,buf:haxe.Int64,__functionAddress:haxe.Int64):Void;
	@:overload(function (source:Int,type:Int,id:Int,severity:Int,length:Int,buf:haxe.Int64):Void {})
 ...
 */
	static public function glGetDebugMessageLogARB(count:Int,bufSize:Int,sources:java.nio.ByteBuffer,types:java.nio.ByteBuffer,ids:java.nio.ByteBuffer,severities:java.nio.ByteBuffer,lengths:java.nio.ByteBuffer,messageLog:java.nio.ByteBuffer):Int;
 ...
 */
	static public function GLDebugMessageARBCallback(sam:org.lwjgl.opengl.GLDebugMessageARBCallback_SAM):org.lwjgl.opengl.GLDebugMessageARBCallback;
...
/** JNI method for {@link #glDebugMessageControlARB DebugMessageControlARB}  */
	static public function nglDebugMessageControlARB(source:Int,type:Int,severity:Int,count:Int,ids:haxe.Int64,enabled:Bool,__functionAddress:haxe.Int64):Void;
...
/** Returns the {@link ARBDebugOutput} instance for the current context.  */
	static public function getInstance():org.lwjgl.opengl.ARBDebugOutput;
/**
...
/** Alternative version of: {@link #glDebugMessageControlARB DebugMessageControlARB}  */
	static public function glDebugMessageControlARB(source:Int,type:Int,severity:Int,count:Int,ids:java.nio.IntBuffer,enabled:Bool):Void;
	@:overload(function (source:Int,type:Int,severity:Int,count:Int,ids:java.nio.ByteBuffer,enabled:Bool):Void {})
/** JNI method for {@link #glDebugMessageCallbackARB DebugMessageCallbackARB}  */
	static public function nglDebugMessageCallbackARB(callback_:haxe.Int64,userParam:haxe.Int64,__functionAddress:haxe.Int64):Void;
