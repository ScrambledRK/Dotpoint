...
@:native("org.lwjgl.opengl.OVRMultiview")
@:final
/**
 ...
 */
extern class OVRMultiview 
{
/** Accepted by the {@code pname} parameter of GetFramebufferAttachmentParameteriv.  */
	inline static public var GL_FRAMEBUFFER_ATTACHMENT_TEXTURE_NUM_VIEWS_OVR:Int = 38448;
/** Accepted by the {@code pname} parameter of GetFramebufferAttachmentParameteriv.  */
	inline static public var GL_FRAMEBUFFER_ATTACHMENT_TEXTURE_BASE_VIEW_INDEX_OVR:Int = 38450;
/** Accepted by the {@code pname} parameter of GetIntegerv.  */
	inline static public var GL_MAX_VIEWS_OVR:Int = 38449;
/** Returned by CheckFramebufferStatus.  */
	inline static public var GL_FRAMEBUFFER_INCOMPLETE_VIEW_TARGETS_OVR:Int = 38451;
/** Function address.  */
	public var FramebufferTextureMultiviewOVR:haxe.Int64;
 ...
 */
	static public function glFramebufferTextureMultiviewOVR(target:Int,attachment:Int,texture:Int,level:Int,baseViewIndex:Int,numViews:Int):Void;
/** JNI method for {@link #glFramebufferTextureMultiviewOVR FramebufferTextureMultiviewOVR}  */
	static public function nglFramebufferTextureMultiviewOVR(target:Int,attachment:Int,texture:Int,level:Int,baseViewIndex:Int,numViews:Int,__functionAddress:haxe.Int64):Void;
/** Returns the {@link OVRMultiview} instance for the current context.  */
	static public function getInstance():org.lwjgl.opengl.OVRMultiview;
