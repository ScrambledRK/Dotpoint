...
@:native("org.lwjgl.opengl.ARBTextureBufferObject")
@:final
/**
 ...
 */
extern class ARBTextureBufferObject 
{
/**
 ...
 * GetIntegerv.
 */
	inline static public var GL_TEXTURE_BUFFER_ARB:Int = 35882;
/** Accepted by the {@code pname} parameters of GetBooleanv, GetDoublev, GetFloatv, and GetIntegerv.  */
	inline static public var GL_MAX_TEXTURE_BUFFER_SIZE_ARB:Int = 35883;
/** Accepted by the {@code pname} parameters of GetBooleanv, GetDoublev, GetFloatv, and GetIntegerv.  */
	inline static public var GL_TEXTURE_BINDING_BUFFER_ARB:Int = 35884;
/** Accepted by the {@code pname} parameters of GetBooleanv, GetDoublev, GetFloatv, and GetIntegerv.  */
	inline static public var GL_TEXTURE_BUFFER_DATA_STORE_BINDING_ARB:Int = 35885;
/** Accepted by the {@code pname} parameters of GetBooleanv, GetDoublev, GetFloatv, and GetIntegerv.  */
	inline static public var GL_TEXTURE_BUFFER_FORMAT_ARB:Int = 35886;
/** Function address.  */
	public var TexBufferARB:haxe.Int64;
	public function new(provider:org.lwjgl.system.FunctionProvider):Void;
/** JNI method for {@link #glTexBufferARB TexBufferARB}  */
	static public function nglTexBufferARB(target:Int,internalformat:Int,buffer:Int,__functionAddress:haxe.Int64):Void;
/** Returns the {@link ARBTextureBufferObject} instance for the current context.  */
	static public function getInstance():org.lwjgl.opengl.ARBTextureBufferObject;
/**
 ...
 */
	static public function glTexBufferARB(target:Int,internalformat:Int,buffer:Int):Void;
