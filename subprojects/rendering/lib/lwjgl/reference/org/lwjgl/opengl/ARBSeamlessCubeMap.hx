...
@:native("org.lwjgl.opengl.ARBSeamlessCubeMap")
@:final
/**
 * Native bindings to the <a href="http://www.opengl.org/registry/specs/ARB/seamless_cube_map.txt">ARB_seamless_cube_map</a> extension.
 * 
 ...
 */
extern class ARBSeamlessCubeMap 
{
/**
