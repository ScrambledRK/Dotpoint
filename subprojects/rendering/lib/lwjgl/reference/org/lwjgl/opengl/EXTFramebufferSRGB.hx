...
@:native("org.lwjgl.opengl.EXTFramebufferSRGB")
@:final
/**
 * Native bindings to the <a href="http://www.opengl.org/registry/specs/EXT/framebuffer_sRGB.txt">EXT_framebuffer_sRGB</a> extension.
 * 
 ...
 */
extern class EXTFramebufferSRGB 
{
/**
 * Accepted by the {@code cap} parameter of Enable, Disable, and IsEnabled, and by the {@code pname} parameter of GetBooleanv, GetIntegerv, GetFloatv, and
 * GetDoublev.
 */
	inline static public var GL_FRAMEBUFFER_SRGB_EXT:Int = 36281;
/** Accepted by the {@code pname} parameter of GetBooleanv, GetIntegerv, GetFloatv, and GetDoublev.  */
	inline static public var GL_FRAMEBUFFER_SRGB_CAPABLE_EXT:Int = 36282;
