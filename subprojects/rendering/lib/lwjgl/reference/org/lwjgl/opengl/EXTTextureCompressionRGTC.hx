...
@:native("org.lwjgl.opengl.EXTTextureCompressionRGTC")
@:final
/**
 * Native bindings to the <a href="http://www.opengl.org/registry/specs/EXT/texture_compression_rgtc.txt">EXT_texture_compression_rgtc</a> extension.
 * 
 ...
 */
extern class EXTTextureCompressionRGTC 
{
/**
 ...
 */
	inline static public var GL_COMPRESSED_RED_RGTC1_EXT:Int = 36283;
/**
 * Accepted by the {@code internalformat} parameter of TexImage2D, CopyTexImage2D, and CompressedTexImage2D and the {@code format} parameter of
 * CompressedTexSubImage2D.
 */
	inline static public var GL_COMPRESSED_SIGNED_RED_RGTC1_EXT:Int = 36284;
/**
 * Accepted by the {@code internalformat} parameter of TexImage2D, CopyTexImage2D, and CompressedTexImage2D and the {@code format} parameter of
 * CompressedTexSubImage2D.
 */
	inline static public var GL_COMPRESSED_RED_GREEN_RGTC2_EXT:Int = 36285;
/**
 * Accepted by the {@code internalformat} parameter of TexImage2D, CopyTexImage2D, and CompressedTexImage2D and the {@code format} parameter of
 * CompressedTexSubImage2D.
 */
	inline static public var GL_COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT:Int = 36286;
