...
@:native("org.lwjgl.opengl.EXTFramebufferMultisample")
@:final
/**
 ...
 */
extern class EXTFramebufferMultisample 
{
/** Accepted by the {@code pname} parameter of GetRenderbufferParameterivEXT.  */
	inline static public var GL_RENDERBUFFER_SAMPLES_EXT:Int = 36011;
/** Returned by CheckFramebufferStatusEXT.  */
	inline static public var GL_FRAMEBUFFER_INCOMPLETE_MULTISAMPLE_EXT:Int = 36182;
/** Accepted by the {@code pname} parameter of GetBooleanv, GetIntegerv, GetFloatv, and GetDoublev.  */
	inline static public var GL_MAX_SAMPLES_EXT:Int = 36183;
/** Function address.  */
	public var RenderbufferStorageMultisampleEXT:haxe.Int64;
 ...
 * @param height         
 */
	static public function glRenderbufferStorageMultisampleEXT(target:Int,samples:Int,internalformat:Int,width:Int,height:Int):Void;
/** JNI method for {@link #glRenderbufferStorageMultisampleEXT RenderbufferStorageMultisampleEXT}  */
	static public function nglRenderbufferStorageMultisampleEXT(target:Int,samples:Int,internalformat:Int,width:Int,height:Int,__functionAddress:haxe.Int64):Void;
/** Returns the {@link EXTFramebufferMultisample} instance for the current context.  */
	static public function getInstance():org.lwjgl.opengl.EXTFramebufferMultisample;
