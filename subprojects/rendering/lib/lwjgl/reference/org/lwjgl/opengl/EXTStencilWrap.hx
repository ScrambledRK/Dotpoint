...
@:native("org.lwjgl.opengl.EXTStencilWrap")
@:final
/**
 * Native bindings to the <a href="http://www.opengl.org/registry/specs/EXT/stencil_wrap.txt">EXT_stencil_wrap</a> extension.
 * 
 ...
 */
extern class EXTStencilWrap 
{
/** Accepted by the {@code sfail}, {@code dpfail}, and {@code dppass} parameter of StencilOp.  */
	inline static public var GL_INCR_WRAP_EXT:Int = 34055;
/** Accepted by the {@code sfail}, {@code dpfail}, and {@code dppass} parameter of StencilOp.  */
	inline static public var GL_DECR_WRAP_EXT:Int = 34056;
