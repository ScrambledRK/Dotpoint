...
@:native("org.lwjgl.opengl.ARBTextureRectangle")
@:final
/**
 * Native bindings to the <a href="http://www.opengl.org/registry/specs/ARB/texture_rectangle.txt">ARB_texture_rectangle</a> extension.
 * 
 ...
 * (and {@link ATITextureMirrorOnce#GL_MIRROR_CLAMP_ATI MIRROR_CLAMP_ATI} and {@link ATITextureMirrorOnce#GL_MIRROR_CLAMP_TO_EDGE_ATI MIRROR_CLAMP_TO_EDGE_ATI} if <a href="http://www.opengl.org/registry/specs/ATI/texture_mirror_once.txt">ATI_texture_mirror_once</a> is
 * supported). NPOTS textures do not support an optional 1-texel border; POTS textures do support an optional 1-texel border.</p>
 * 
 ...
 */
extern class ARBTextureRectangle 
{
/**
 ...
 * TexParameteriv.
 */
	inline static public var GL_TEXTURE_RECTANGLE_ARB:Int = 34037;
/** Accepted by the {@code pname} parameter of GetBooleanv, GetIntegerv, GetFloatv and GetDoublev.  */
	inline static public var GL_TEXTURE_BINDING_RECTANGLE_ARB:Int = 34038;
/** Accepted by the {@code target} parameter of GetTexLevelParameteriv, GetTexLevelParameterfv, GetTexParameteriv and TexImage2D.  */
	inline static public var GL_PROXY_TEXTURE_RECTANGLE_ARB:Int = 34039;
/** Accepted by the {@code pname} parameter of GetBooleanv, GetDoublev, GetIntegerv and GetFloatv.  */
	inline static public var GL_MAX_RECTANGLE_TEXTURE_SIZE_ARB:Int = 34040;
/**
