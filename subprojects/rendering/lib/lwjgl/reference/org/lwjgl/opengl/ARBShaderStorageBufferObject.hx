...
@:native("org.lwjgl.opengl.ARBShaderStorageBufferObject")
@:final
/**
 ...
 */
extern class ARBShaderStorageBufferObject 
{
...
/** Returns the {@link ARBShaderStorageBufferObject} instance for the current context.  */
	static public function getInstance():org.lwjgl.opengl.ARBShaderStorageBufferObject;
