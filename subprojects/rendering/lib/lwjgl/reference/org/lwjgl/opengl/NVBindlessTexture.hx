...
@:native("org.lwjgl.opengl.NVBindlessTexture")
@:final
/**
 ...
 */
extern class NVBindlessTexture 
{
/** Function address.  */
	public var GetTextureHandleNV:haxe.Int64;
/** Function address.  */
	public var GetTextureSamplerHandleNV:haxe.Int64;
/** Function address.  */
	public var MakeTextureHandleResidentNV:haxe.Int64;
/** Function address.  */
	public var MakeTextureHandleNonResidentNV:haxe.Int64;
/** Function address.  */
	public var GetImageHandleNV:haxe.Int64;
/** Function address.  */
	public var MakeImageHandleResidentNV:haxe.Int64;
/** Function address.  */
	public var MakeImageHandleNonResidentNV:haxe.Int64;
/** Function address.  */
	public var UniformHandleui64NV:haxe.Int64;
/** Function address.  */
	public var UniformHandleui64vNV:haxe.Int64;
/** Function address.  */
	public var ProgramUniformHandleui64NV:haxe.Int64;
/** Function address.  */
	public var ProgramUniformHandleui64vNV:haxe.Int64;
/** Function address.  */
	public var IsTextureHandleResidentNV:haxe.Int64;
/** Function address.  */
	public var IsImageHandleResidentNV:haxe.Int64;
	public function new(provider:org.lwjgl.system.FunctionProvider):Void;
/** JNI method for {@link #glGetTextureHandleNV GetTextureHandleNV}  */
	static public function nglGetTextureHandleNV(texture:Int,__functionAddress:haxe.Int64):haxe.Int64;
/**
 ...
 */
	static public function glIsImageHandleResidentNV(handle:haxe.Int64):Bool;
/**
 ...
 */
	static public function glGetTextureSamplerHandleNV(texture:Int,sampler:Int):haxe.Int64;
/**
 * Makes an image handle inaccessible to shaders.
 *
 * @param handle the image handle
 */
	static public function glMakeImageHandleNonResidentNV(handle:haxe.Int64):Void;
/** JNI method for {@link #glUniformHandleui64NV UniformHandleui64NV}  */
	static public function nglUniformHandleui64NV(location:Int,value:haxe.Int64,__functionAddress:haxe.Int64):Void;
 ...
 */
	static public function glUniformHandleui64vNV(location:Int,count:Int,values:java.nio.ByteBuffer):Void;
 ...
 * @param texture the texture object
 */
	static public function glGetTextureHandleNV(texture:Int):haxe.Int64;
/** JNI method for {@link #glMakeTextureHandleNonResidentNV MakeTextureHandleNonResidentNV}  */
	static public function nglMakeTextureHandleNonResidentNV(handle:haxe.Int64,__functionAddress:haxe.Int64):Void;
/** JNI method for {@link #glMakeImageHandleResidentNV MakeImageHandleResidentNV}  */
	static public function nglMakeImageHandleResidentNV(handle:haxe.Int64,access:Int,__functionAddress:haxe.Int64):Void;
/**
 ...
 */
	static public function glMakeImageHandleResidentNV(handle:haxe.Int64,access:Int):Void;
/**
 ...
 */
	static public function glUniformHandleui64NV(location:Int,value:haxe.Int64):Void;
 ...
 * @param values   a buffer from which to load the handles
 */
	static public function glProgramUniformHandleui64vNV(program:Int,location:Int,count:Int,values:java.nio.ByteBuffer):Void;
...
/** JNI method for {@link #glMakeImageHandleNonResidentNV MakeImageHandleNonResidentNV}  */
	static public function nglMakeImageHandleNonResidentNV(handle:haxe.Int64,__functionAddress:haxe.Int64):Void;
...
/** JNI method for {@link #glUniformHandleui64vNV UniformHandleui64vNV}  */
	static public function nglUniformHandleui64vNV(location:Int,count:Int,values:haxe.Int64,__functionAddress:haxe.Int64):Void;
...
/** JNI method for {@link #glIsTextureHandleResidentNV IsTextureHandleResidentNV}  */
	static public function nglIsTextureHandleResidentNV(handle:haxe.Int64,__functionAddress:haxe.Int64):Bool;
/**
 * Returns {@link GL11#GL_TRUE TRUE} if the specified texture handle is resident in the current context.
 *
 * @param handle the texture handle
 */
	static public function glIsTextureHandleResidentNV(handle:haxe.Int64):Bool;
/** JNI method for {@link #glGetImageHandleNV GetImageHandleNV}  */
	static public function nglGetImageHandleNV(texture:Int,level:Int,layered:Bool,layer:Int,format:Int,__functionAddress:haxe.Int64):haxe.Int64;
/** JNI method for {@link #glIsImageHandleResidentNV IsImageHandleResidentNV}  */
	static public function nglIsImageHandleResidentNV(handle:haxe.Int64,__functionAddress:haxe.Int64):Bool;
/**
 ...
 * @param value    the handle value
 */
	static public function glProgramUniformHandleui64NV(program:Int,location:Int,value:haxe.Int64):Void;
/**
 ...
 * @param handle the texture handle
 */
	static public function glMakeTextureHandleResidentNV(handle:haxe.Int64):Void;
/**
 ...
 */
	static public function glGetImageHandleNV(texture:Int,level:Int,layered:Bool,layer:Int,format:Int):haxe.Int64;
/** JNI method for {@link #glMakeTextureHandleResidentNV MakeTextureHandleResidentNV}  */
	static public function nglMakeTextureHandleResidentNV(handle:haxe.Int64,__functionAddress:haxe.Int64):Void;
/** JNI method for {@link #glGetTextureSamplerHandleNV GetTextureSamplerHandleNV}  */
	static public function nglGetTextureSamplerHandleNV(texture:Int,sampler:Int,__functionAddress:haxe.Int64):haxe.Int64;
/** Returns the {@link NVBindlessTexture} instance for the current context.  */
	static public function getInstance():org.lwjgl.opengl.NVBindlessTexture;
...
/** JNI method for {@link #glProgramUniformHandleui64vNV ProgramUniformHandleui64vNV}  */
	static public function nglProgramUniformHandleui64vNV(program:Int,location:Int,count:Int,values:haxe.Int64,__functionAddress:haxe.Int64):Void;
 ...
 * @param handle the texture handle
 */
	static public function glMakeTextureHandleNonResidentNV(handle:haxe.Int64):Void;
/** JNI method for {@link #glProgramUniformHandleui64NV ProgramUniformHandleui64NV}  */
	static public function nglProgramUniformHandleui64NV(program:Int,location:Int,value:haxe.Int64,__functionAddress:haxe.Int64):Void;
